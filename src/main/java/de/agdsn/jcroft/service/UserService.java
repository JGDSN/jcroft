    ...
    */
    ...
    public void removeUser (String username) {
        ...
        if (!userOptional.isPresent()) {
            logger.log(Level.FINE, "Its not neccessary to remove user {0}, because user doesnt exists.", username);
    ...
    public void removeUserById (int userID) {
        ...
        if (!userOptional.isPresent()) {
            logger.log(Level.FINE, "Its not neccessary to remove user with id {0}, because user doesnt exists.", userID);
